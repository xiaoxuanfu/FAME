...
class starbucksnews extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<starbucksnews> {
  List data = [];
  ...
  Future<String> fetch_data_from_api() async {
    var jsondata = await http.get(Uri.parse(
        "http://newsapi.org/v2/everything?q=starbucks&apiKey=0b0b712f35b54dae9b147f3105cf60cc"));
